...
;(function($, window, document, undefined)
{
	...
	Plugin.prototype = {
		...
		setParent: function(li)
		{
			if (li.children(this.options.listNodeName).length) {
				...
				li.find(".dd3-content").first().after('<div class="progress"> <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100" style="width: 0%";> </div></div>');
    ...
    $(document).on('click', '.removeT', function() {
	  ...
	  var listp2 = $('#nestable3').data('nestable');
      closest2 = $(this).closest("li");
      closestOfParent = closest2.parents('.dd-item')      
      ...
      closest = $(this).closest("li").remove();

      dataid = closest.data('id');
      
      // console.log(dataid);
      childs = closest.find("li").remove();
    
      if ($("#mainWrapper li").length == 0) {
      	$("#notasks").show();
      }


      
  //    	var list = $('#nestable3').data('nestable');
		// $('.dd-item').each(function() {
		//     var item = $(this),
		//     parent = item.parent();
		//     list.unsetParent(item);
